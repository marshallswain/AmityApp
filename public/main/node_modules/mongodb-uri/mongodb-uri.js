 ...
 * @return {Object}
 */
MongodbUriParser.parse = function(uri) {
 ...
 * @private
 */
MongodbUriParser._parseAddress = function(address, uriObject) {
    uriObject.hosts = [];
 ...
 * @return {String}
 */
MongodbUriParser.format = function(uriObject) {
 ...
 * @private
 */
MongodbUriParser._formatAddress = function(uriObject) {
    var address = '';
 ...
 * @return {String}
 */
MongodbUriParser.formatMongoose = function(uri) {
    var parser = this;
