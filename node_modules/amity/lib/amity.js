...
var amity = {
	...
	use: function(adapter){
		...
		// // Loop through the amity_ groups...
		// for (var i = keys.length - 1; i >= 0; i--) {
		...
		// 		var endpoint = self.apiPrefix + '/' + adapter.namespace + '/' + amityGroup[n].name;
		// 		console.log(endpoint);
		// 		// console.log(amityGroup[n].service);
		// 		//

		// 		// and use it to register the Feathers service.
		// 		self.app.use(endpoint, adapter[amityGroup][n].service);
		// 		// self.app.use(endpoint, require('./services/todos'));
