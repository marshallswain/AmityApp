 ...
 *
 *
 * Each instance will manage as much as one server. (It might manage a partial server.)
 *
...
var amityMongo = {
	// TODO: Should app be added upon amity.use() ???
	app:null,
	dbType:'mongodb',
	type:'server',
	namespace:'',
...
module.exports = function(config) {
	...
	if (typeof config == 'string') {
		...
		MongoClient.connect(config, function(err, db) {
		  ...
		  var service = feathersMongoDBs(adminDB);

		  // Add the db manager to the list of amity_ services.
		  amityMongo.amity_dbManager.push({'name':'_databases', service:service});
